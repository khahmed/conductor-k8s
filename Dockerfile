...
# Run:   docker run -it --net=host --privileged -e MASTERNAME=cfc-master conductor-spark:2.2
...
RUN cd /;wget --quiet --no-proxy http://9.29.133.27:9191/${CWS_INSTALL_PKG};chmod 755 /${CWS_INSTALL_PKG};/${CWS_INSTALL_PKG} --quiet; rm -f /${CWS_INSTALL_PKG}
